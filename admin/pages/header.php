...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-topnav">
    ...
    <!-- SEARCH FORM -->
    <!-- <form action="dashboard?dil=home" method="GET" class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" name="s" type="search" placeholder="Search" aria-label="Search">
        <input class="form-control form-control-navbar" name="dil" type="hidden" placeholder="Search" value="<?php //if(isset($_GET['dil'])){ echo $_GET['home']; } else { echo ""; } ?>">
