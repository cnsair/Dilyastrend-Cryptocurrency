...
<html>
<head>
<title>DilyasTrend.com/TeamMembers</title>
			...
			<div class="row">
			  <div class="col-md-12">
				 <div class="header-left">
					 <div class="logo">
						<a href="index.html"><img src="images/IMG-20200724-WA0021.jpg" width="200px" height="200px" alt=""/></a>
					 </div>
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/IMG-20200724-WA0021.jpg" width="200px" height="200px" alt="" /></a>
						    <ul class="nav" id="nav">
					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 ...
							 <div class="login_button"><a href="Signin.php">Signin</a></div>
							 <div class="contact_button"><a href="contact.php"></a></div>
							 <div class="clear"></div>
						  </div>
						  <div class="clear"></div>
						</ul>
